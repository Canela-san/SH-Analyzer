...
/* Pinos SPI */
#define SCLK_PIN  (1 << 0)  // Terminal 31 (SPI1_SCLK)
#define MISO_PIN  (1 << 1)  // Terminal 29 (SPI1_D0) - Agora é a Entrada
#define MOSI_PIN  (1 << 2)  // Terminal 30 (SPI1_D1) - Agora é a Saída
#define CS_PIN    (1 << 3)  // Terminal 28 (SPI1_CS0)
